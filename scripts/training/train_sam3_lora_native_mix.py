...
# torchrun --nproc_per_node 2 scripts/training/train_sam3_lora_native_mix.py --config configs/vaihingen_lora_config.yaml --device 0 1
# torchrun --nproc_per_node 2 scripts/training/train_sam3_lora_native_mix.py --config configs/potsdam_lora_config.yaml --device 0 1
