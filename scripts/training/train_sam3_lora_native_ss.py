...
class SAM3TrainerNative:
    ...
    def train(self):
        ...
        if dataset_type == "isprsRef":
            ...
            train_ds = ISPRSRefDataset_SS(
                data_dir=data_dir, 
                unlabeled_dir="/home/icclab/Documents/lqw/DatasetMMF/PotsdamRef/",
                # unlabeled_mask_path="/home/icclab/Documents/lqw/DatasetMMF/PotsdamRef/unlabeled_valid_concept_SAM3new",
                # unlabeled_text_path="/home/icclab/Documents/lqw/DatasetMMF/PotsdamRef/output_phrase_val_concept.txt",
                unlabeled_mask_path="/home/icclab/Documents/lqw/DatasetMMF/PotsdamRef/unlabeled_valid_standard_SAM3newf",
...
# CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node 1 scripts/training/train_sam3_lora_native_ss.py --config configs/vaihingen_lora_config.yaml --device 0
# torchrun --nproc_per_node 2 scripts/training/train_sam3_lora_native_ss.py --config configs/vaihingen_lora_config.yaml --device 0 1
# torchrun --nproc_per_node 2 scripts/training/train_sam3_lora_native_ss.py --config configs/potsdam_lora_config.yaml --device 0 1
